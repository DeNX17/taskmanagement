...
const labels_repository_1 = require("./labels.repository");
...
LabelsService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(labels_repository_1.LabelsRepository)),
    __metadata("design:paramtypes", [labels_repository_1.LabelsRepository])
], LabelsService);
